        ...
        <div className='flex flex-col sm:flex-row w-full gap-8 max-w pr-[30px]'>
                        ...
                        <Masonry gutter='10px'>
                            {photos.map((p) => (
                                ...
                                >
                                    ...
                                    <img src={p.jpeg_url} className='w-full h-full object-cover hover:scale-105 transition' alt={p.slug} />
                                    {/* <AutosizeImage
                                        src={p.jpeg_url}
            ...
            <div className='flex-1 max-w-[512px]'>
                ...
                <div className='bg-black w-full aspect-square relative overflow-hidden'>
                    {output && <img src={String(output)} alt='output-img' className={`w-full h-full top-0 left-0 transition ${isLoadingGeneration ? 'blur-sm' : ''}`} />}
