...
export default function GalleryNavBar(props: GalleryNavBarProps) {
    return (
        <nav className="relative top-0 left-0 w-full py-8 px-[25px] md:px-[90px] bg-black text-grey">
            <div className='min-h-[28px] flex flex-row justify-between items-center'>
                ...
                <div className='hidden md:block'>{props.children || <div className='w-[118px]'/>}</div>
            </div>
        </nav>
    )
}