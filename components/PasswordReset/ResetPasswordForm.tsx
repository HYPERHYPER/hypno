    ...
    return (
        <>
            <div className='space-y-3'>
                ...
                <h1 className='text-primary text-3xl'>enter and confirm your new password</h1>
            </div>
            {!success ? (
                <>
                    <form className='flex flex-col w-full border-t-2 border-white/20' onSubmit={handleSubmit(submitResetPassword)}>
                        ...
                        <input type='submit' value='reset' className={clsx('btn btn-primary rounded-lg mt-10 text-4xl h-[80px]', isLoading && 'hidden')} />
