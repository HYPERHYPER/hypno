...
const FEATURE_ACCESS: FeatureAccess = {
    "camera": ['free', 'creator', 'agency', 'brand'],
    "filters": ['free', 'creator', 'agency', 'brand'],
    "graphics": ['creator', 'agency', 'brand'],
    "effects": ['creator', 'agency', 'brand'],
    "canon": ['agency', 'brand'],
    "gallery": ['free', 'creator', 'agency', 'brand'],
    "branding": ['creator', 'agency', 'brand'],
    "data capture": ['brand'],
    "custom legal": ['brand'],
    "your domain": ['brand'],
    "api access": ['brand'],
    "live support": ['agency', 'brand'],
    "studio services": ['agency', 'brand'],
    "hypno community": ['agency', 'brand']
}
...
const AGENCY_PLAN = 'price_1NT8G6A3gTSa41CeZ2XYleYk'
const AGENCY_PLAN_DISCOUNTED = 'price_1NQxrDA3gTSa41CeORPpKPGl'
...
const getProductId = (plan_type: string, subscription: 'annual' | 'monthly') => {
    switch (plan_type) {
        ...
        case 'agency': return subscription == 'monthly' ? AGENCY_PLAN : AGENCY_PLAN_DISCOUNTED;
                ...
                {isLoading ? (
                    ...
                    <div>
                        ...
                        <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                            {_.map(['free', 'creator', 'agency', 'brand'], (type, i) => (
