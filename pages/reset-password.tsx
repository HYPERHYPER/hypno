...
function ResetPasswordPage() {
    ...
    return (
        <>
            <Head>
                <title>reset password | hypno™</title>
            ...
            <main className='fixed inset-0 bg-black w-screen min-h-screen'>
                ...
                <div className='hero min-h-screen'>
                    <div className='hero-content px-6 sm:max-w-xl w-full text-center flex-col'>
                        <h1 className='text-white text-3xl sm:text-5xl'>{success ? 'success.' : 'reset password.'}</h1>
                        {!success ? (
                            <>
                                <form className='flex flex-col gap-4 w-full my-4' onSubmit={handleSubmit(submitResetPassword)}>
                                    <input
                                    ...
                                    />
                                    <input type='submit' value='reset' className='btn btn-gallery sm:btn-lg btn-primary rounded-full mt-3' />
                                </form>
                                {error && (
