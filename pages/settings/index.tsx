...
function SettingsPage() {
  ...
  return (
    <>
      <Head>
        <title>
          {user.first_name} {user.last_name} | hypno™
        </title>
        <meta
          name="description"
      ...
      <GlobalLayout paymentPlansModal={true}>
          ...
          right={
            <div className="avatar placeholder indicator">
              ...
              <Modal.Trigger id="avatar-modal">
                <span className="indicator-item indicator-top indicator-end translate-x-1 translate-y-1 btn btn-primary btn-sm btn-circle rounded-full">
                  <Plus />
                </span>
              </Modal.Trigger>
            </div>
        ...
        >
          <button onClick={handleLogout}>
            <h2 className="text-primary">sign out</h2>
          </button>
        </GlobalLayout.Header>
...
const Item = ({
  ...
  return (
    <div className="item">
      ...
      <label
        htmlFor={modalId}
        className={clsx("text-primary lowercase", modalId && "cursor-pointer")}
      >
